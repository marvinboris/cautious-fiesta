...
import { faTachometerAlt, faUserTie, faCog, faUserTag, faTools, faUser, faUserCog, faLanguage, faBell, faWrench, faBlog, faTag } from '@fortawesome/free-solid-svg-icons';
    ...
    const {
        pages: {
            backend: {
                sidebar: {
                    user, admin,
                    menu: { dashboard, admins, users, roles, categories, drivers, features, languages, cms: cms_, notifications: notifications_, settings, }
                }
            }
        }
    } = cms;
    ...
    switch (role) {
        case 'user':
            ...
            sideDrawerItems = <>
                ...
                {sideDrawerItem(false, null, categories, faTag, "/user/categories")}
                {sideDrawerItem(false, null, drivers, faUserTag, "/user/drivers")}
        ...
        case 'admin':
            sideDrawerItems = <>
                ...
                {sideDrawerItem(true, null, categories, faTag, "/admin/categories")}
                {sideDrawerItem(true, null, drivers, faUserTag, "/admin/drivers")}
