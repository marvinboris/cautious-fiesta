...
const categoriesReset = (state, action) => updateObject(state, { categories: initialState.categories });
const categoriesStart = (state, action) => updateObject(state, { categories: updateObject(state.categories, { loading: true, message: null }) });
...
const driversReset = (state, action) => updateObject(state, { drivers: initialState.drivers });
const driversStart = (state, action) => updateObject(state, { drivers: updateObject(state.drivers, { loading: true, message: null }) });
const driversSuccess = (state, action) => updateObject(state, { drivers: updateObject(state.drivers, { loading: false, error: null, ...action }) });
const driversFail = (state, action) => updateObject(state, { drivers: updateObject(state.drivers, { loading: false, ...action }) });
...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.DRIVERS_RESET: return driversReset(state, action);
        case actionTypes.DRIVERS_START: return driversStart(state, action);
        case actionTypes.DRIVERS_SUCCESS: return driversSuccess(state, action);
        case actionTypes.DRIVERS_FAIL: return driversFail(state, action);
