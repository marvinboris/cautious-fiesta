...
class Add extends Component {
    ...
    render() {
        let {
            content: {
                cms: {
                    pages: { components: { form: { save } }, backend: { pages: { categories: { title, add, index, form } } } }
                }
            },
        ...
        if (loading) content = <Col xs={12}>
            ...
            content = (
                <>
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={faTag} title={add} list={index} link="/user/categories" innerClassName="row" className="shadow-sm">
                            <Col lg={8}>
        ...
        return (
            <>
                <div className="bg-soft py-4 pl-5 pr-4 position-relative">
                    <Breadcrumb main={add} icon={faTag} />
