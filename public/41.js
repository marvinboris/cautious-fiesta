...
/***/ "./resources/js/src/containers/Backend/User/Categories/index.js":
/*!**********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Categories/index.js ***!
  \**********************************************************************/
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c2 = _this$props$content$c.backend.pages.categories,
          title = _this$props$content$c2.title,
          add = _this$props$content$c2.add,
          index = _this$props$content$c2.index,
          name = _this$props$content$c2.form.name,
          ...
          categories = _this$props$backend$c.categories,
      ...
      var data = categories.map(function (category) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_14__["updateObject"])(category, {
          action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "text-center"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], {
            to: "/user/categories/".concat(category.id),
            className: "mr-2"
            ...
            to: "/user/categories/".concat(category.id, "/edit"),
            className: "mx-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
            ...
            deleteAction: function deleteAction() {
              return _this.props["delete"](category.id);
            }
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["getCategories"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_13__["deleteCategories"](id));
    },
