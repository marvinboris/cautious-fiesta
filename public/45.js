...
/***/ "./resources/js/src/containers/Backend/User/Drivers/Edit.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Drivers/Edit.js ***!
  \******************************************************************/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                _context.next = 3;
                return _this.props.patch(_this.props.match.params.driverId, e.target);
  ...
  _createClass(Add, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                this.props.reset();
                this.props.get(this.props.match.params.driverId);
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.backend.pages.drivers,
          ...
          _this$props$backend$d = _this$props.backend.drivers,
          loading = _this$props$backend$d.loading,
          error = _this$props$backend$d.error,
          message = _this$props$backend$d.message,
          driver = _this$props$backend$d.driver,
          categories = _this$props$backend$d.categories,
          features = _this$props.auth.data.role.features;
      var _this$state = this.state,
          first_name = _this$state.first_name,
          last_name = _this$state.last_name,
          nid = _this$state.nid,
          driving_license = _this$state.driving_license,
      ...
      if (loading) content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_4__["Col"], {
        ...
        content = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_4__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Backend_UI_Form_Form__WEBPACK_IMPORTED_MODULE_13__["default"], {
          ...
          required: true,
          placeholder: form.driving_license
        }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_Backend_UI_Input_Input__WEBPACK_IMPORTED_MODULE_14__["default"], {
          type: "text",
          className: "col-md-6",
          icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__["faIdCard"],
          ...
          required: true,
          value: category_id
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("option", null, form.select_category), categoriesOptions), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("input", {
          type: "file",
          id: "photo",
          name: "photo",
          className: "d-none",
        ...
        }, photo && photo !== driver.photo && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.drivers.driver && prevState.first_name === '') {
        var driver = nextProps.backend.drivers.driver;
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_18__["updateObject"])(prevState, _objectSpread({}, driver));
      }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__["getDriver"](id));
    },
    patch: function patch(id, data) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__["patchDrivers"](id, data));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_17__["resetDrivers"]());
    }
  };
};
