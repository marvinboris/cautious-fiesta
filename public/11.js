...
/***/ "./resources/js/src/containers/Backend/User/Drivers/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Drivers/index.js ***!
  \*******************************************************************/
/*! exports provided: default */
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          nid = _this$props$content$c4.nid,
          driving_license = _this$props$content$c4.driving_license,
          card = _this$props$content$c4.card,
          photo = _this$props$content$c4.photo,
          driver_photo = _this$props$content$c4.driver_photo,
          ...
          drivers = _this$props$backend$d.drivers,
      ...
      if (!drivers) drivers = [];
      var data = drivers.map(function (driver) {
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_15__["updateObject"])(driver, {
          photo: driver.photo && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "d-flex"
            ...
            title: "".concat(driver_photo, ": ").concat(driver.name),
          ...
          action: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            ...
            to: "/user/drivers/".concat(driver.id),
            className: "mr-2"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
            icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_5__["faEye"],
            ...
            to: "/user/drivers/".concat(driver.id, "/edit"),
            className: "mx-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
            ...
            deleteAction: function deleteAction() {
              return _this.props["delete"](driver.id);
            }
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_4__["FontAwesomeIcon"], {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["getDrivers"](page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["deleteDrivers"](id));
    },
    reset: function reset() {
      return dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_14__["resetDrivers"]());
    }
  };
};
