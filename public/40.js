...
/***/ "./resources/js/src/containers/Backend/User/Categories/Edit.js":
/*!*********************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Categories/Edit.js ***!
  \*********************************************************************/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                _context.next = 3;
                return _this.props.patch(_this.props.match.params.categoryId, e.target);
  ...
  _createClass(Add, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      if (nextProps.backend.categories.category && prevState.first_name === '') {
        ...
        return Object(_shared_utility__WEBPACK_IMPORTED_MODULE_17__["updateObject"])(prevState, _objectSpread({}, category));
      }
